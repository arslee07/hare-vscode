...
This extension adds basic support for the [Hare](https://harelang.org/) programming language.
...
Thanks to Dubhead for [Universal Ctags optlib for Hare](https://chiselapp.com/user/Dubhead/repository/Ctags_optlib_Hare)!
